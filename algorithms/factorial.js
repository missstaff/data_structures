...
function findFactorialRecursive(number) {
  ...
  if (number === 2) {
    //when 2 is returned the previous recursive calls then run, popping off the stack, returning the decremeted value from each call and multiplying it be the next call in the stack.
    return 2;
  }
